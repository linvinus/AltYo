...
//~ 		this.override_background_color(StateFlags.NORMAL, c);
	...
	public void reconfigure(){
		...
		string style_str=   "VTToggleButton   {font: \"Mono 8\"; -GtkWidget-focus-padding: 0px;  -GtkButton-default-border:0px; -GtkButton-default-outside-border:0px; -GtkButton-inner-border:0px; border-width: 0px; -outer-stroke-width: 0px; border-radius: 0px; border-style: solid;  background-image: none; margin:0px; padding:1px 1px 0px 1px; background-color: #000000; color: #AAAAAA; transition: 0ms ease-in-out;}"+
					 "VTToggleButton:active   {font: \"Mono 8\"; -GtkWidget-focus-padding: 0px;  -GtkButton-default-border:0px; -GtkButton-default-outside-border:0px; -GtkButton-inner-border:0px; border-width: 0px; -outer-stroke-width: 0px; border-radius: 0px; border-style: solid;  background-image: none; margin:0px; padding:1px 1px 0px 1px; background-color: #00AAAA; color: #000000; transition: 0ms ease-in-out;}"+
					 "VTToggleButton:prelight {font: \"Mono 8\"; -GtkWidget-focus-padding: 0px;  -GtkButton-default-border:0px; -GtkButton-default-outside-border:0px; -GtkButton-inner-border:0px; border-width: 0px; -outer-stroke-width: 0px; border-radius: 0px; border-style: solid;  background-image: none; margin:0px; padding:1px 1px 0px 1px; background-color: #AAAAAA; color: #000000; transition: 0ms ease-in-out;}"+
					 ...
					 "#search_hbox * {background-color: #151515; border-color: @fg_color; color: #00FFAA;}"+
